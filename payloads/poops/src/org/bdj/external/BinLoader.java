...
public class BinLoader {
    ...
    public static void loadFromData(byte[] data) throws Exception {
        ...
        Status.println("mmap() allocated at: 0x" + Long.toHexString(mmapBase) + " (size: 0x"
                + Long.toHexString(mmapSize) + ")");
    ...
    public static void waitForPayloadToExit() throws Exception {
        ...
        if (mmapBase != 0 && mmapSize > 0) {
            Status.println("Cleaning up payload memory at 0x" + Long.toHexString(mmapBase) + " (size: 0x"
                    + Long.toHexString(mmapSize) + ")");
            ...
            Status.println(
                    "No memory to cleanup (mmapBase=0x" + Long.toHexString(mmapBase) + ", mmapSize=" + mmapSize + ")");
        }
